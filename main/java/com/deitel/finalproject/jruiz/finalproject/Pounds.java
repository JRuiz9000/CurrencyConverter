...
public class Pounds extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pounds); //inflate the GUI
   ...
   /* //Print the database
    ...
    private void calculate() {
        ...
        //POUND AMOUNT
        double poundAmount = total * 0.74 * percentSplit;

        //display tip and total formatted as currency
        tipTextView.setText(currencyFormat.format(tip));
        totalTextView.setText(currencyFormat.format(total));
        conTextView.setText(convertedFormat.format(poundAmount)); //"£"
    }
    ...
    private final SeekBar.OnSeekBarChangeListener seekBarListener =
            new SeekBar.OnSeekBarChangeListener() {
                ...
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser)  {
                    ...
                    //startActivity(new Intent(Pounds.this, Pounds.class));
                }

                //Intent intent = getIntent();
                //String messagetext = Intent.getStringExtra("Name of Message");
